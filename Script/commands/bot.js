...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "sany") || (event.body.toLowerCase() == "sani") || (event.body.toLowerCase() == "@sany") || (event.body.toLowerCase() == "সানি")) {
     return api.sendMessage("সানি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "এডমিন")) {
     return api.sendMessage("‎[এডমিন:☞ Sany ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 জানু.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000654976375\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01799721916", threadID);
   };

   if ((event.body.toLowerCase() == "এডমিন কে") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("Admin sany আইডি নাম : তা্ঁমা্ঁক্ঁ পা্ঁতা্ঁ ", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "এডমিন দেও")) {
     return api.sendMessage("He is sany❤️ তাকে সবাই sany নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam")) {
     return api.sendMessage("️- ওয়ালাইকুমুস-সালাম-!!🖤 কেমন আছেন", threadID);
   };

   if ((event.body.toLowerCase() == "আপনি") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "kamon aso") || (event.body.toLowerCase() == "kamon asen apne")) {
     return api.sendMessage("এইতো আলহামদুলিল্লাহ ", threadID);
   };

   if ((event.body.toLowerCase() == "কি করেন") || (event.body.toLowerCase() == "ki koren")) {
     return api.sendMessage("মসা মারি", threadID);
   };

  if ((event.body.toLowerCase() == "খাইসেন") || (event.body.toLowerCase() == "খান")) {
     return api.sendMessage("খামুনা", threadID);
   };
  
  if ((event.body.toLowerCase() == "atika") || (event.body.toLowerCase() == "apu")) {
     return api.sendMessage("খবরদার কেউ এই আপুরে নাম দরে ডাক দিবানা এটা আমার বস sany এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "তানজিনা") || (event.body.toLowerCase() == "ফাতেমা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস sany এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "সবাই চিপায়") || (event.body.toLowerCase() == "sob cipai")) {
     return api.sendMessage("🥰-না আমি চিপায় না", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম হুম কইরো না মাথা গরম আছে🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Apnar name ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁", threadID);
   };

   if ((event.body.toLowerCase() == "সোনা") || (event.body.toLowerCase() == "বাবু")) {
     return api.sendMessage("️ঢং!🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "moriom") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️aj kao nai bole", threadID);
   };

   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️এত চো*দা চু*দি করস কেনো দেখা যাবে বাসর-রাতে-তুই-কতো পারিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিকে ওইদিকে কি দেখো জানু বসের ইনবক্সে মেসেজ দেও ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ফয়সাল ভাই ইমুজি দিও না গুরুপে🌚🐸🌶️🍆", threadID);
   };
